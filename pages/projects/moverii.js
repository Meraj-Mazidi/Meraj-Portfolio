    ...
    <section className="w-screen h-full lg:pl-32 mb-10 xl:container xl:mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center relative">
        ...
        <div className="col-span-1 py-5 pt-5 flex flex-col gap-3 px-10 lg:px-0">
          ...
          <p className="text-white text-7xl font-extrabold w-[80%]">Moverii</p>
          ...
          <p className="md:w-[80%] text-violet text-base font-poppins">
            ...
            surfing or hiking, adventure or relaxation - with them you will find
            the right sports/active trip for your needs. Experience your active
            dream vacation now!
          </p>
      ...
      <div className="mt-[100px] mb-20 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
          ...
          <div className="w-full col-span-1 order-1 md:order-2 px-10 md:pr-10">
            ...
            <p className="md:w-[80%] text-violet text-base font-poppins">
              I had the great honor & privilege of working with the awesome team
              of Moverii. I was working remotely on their incredible web-site to
              develop and create a beautiful & eye-catching master piece! I was
              employed as a Front-end developer and had a satisfying experience
              working on this. I learned lots of new things and made lots of
              great friends in the process. I absolutely loved this useful
              experience.
            </p>
          </div>
        </div>
