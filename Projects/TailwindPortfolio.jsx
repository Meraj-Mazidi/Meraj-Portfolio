...
const BlogImages = [
  {
    image: "/images/projects/TailwindPortfolio/1.png",
  },
  {
    image: "/images/projects/TailwindPortfolio/2.png",
  },
  {
    image: "/images/projects/TailwindPortfolio/3.png",
  },
  {
    image: "/images/projects/TailwindPortfolio/4.png",
  },
  {
    image: "/images/projects/TailwindPortfolio/5.png",
  },
  {
    image: "/images/projects/TailwindPortfolio/6.png",
  },
  {
    image: "/images/projects/TailwindPortfolio/7.png",
  },
  {
    image: "/images/projects/TailwindPortfolio/8.png",
  },
  {
    image: "/images/projects/TailwindPortfolio/9.png",
  },
  {
    image: "/images/projects/TailwindPortfolio/10.png",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mb-48 mt-10 md:mt-0">
        ...
        <div className="flex flex-col gap-4 px-10 md:pl-10 md:pr-0 lg:px-0">
          ...
          <p className="md:w-[90%] lg:w-[80%] text-violet text-base font-poppins mb-5">
            ...
            information. It also has a dark and light mode toggle. <br />
            This is fully responsive and has nice-looking colors, with modern
            design. This portfolio was developed by JavaScript, Tailwind CSS, and
            other useful technologies. <br />
            Please feel free to check out my Tailwind portfolio.
          </p>

          <span className="flex flex-col md:flex-row gap-4 z-10">
            <CustomButton
              text="View the Project"
              href="https://meraj-mazidi.github.io/Tailwind-portfolio/"
              target="_blank"
            />
            <CustomButton
              text="View On GitHub"
              href="https://github.com/Meraj-Mazidi/Tailwind-portfolio"
              target="_blank"
            />
          </span>
        </div>
        ...
        <div className="flex flex-col justify-center items-center z-10 px-6 lg:px-0 mt-20 md:mt-0">
          ...
          >
            ...
            >
              <img
                src={"/images/projects/Tailwind-Portfolio.png"}
                alt="projectDemo"
