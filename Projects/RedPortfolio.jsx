...
const BlogImages = [
  {
    image: "/images/projects/RedPortfolio/1.png",
  },
  {
    image: "/images/projects/RedPortfolio/2.png",
  },
  {
    image: "/images/projects/RedPortfolio/3.png",
  },
  {
    image: "/images/projects/RedPortfolio/4.png",
  },
  {
    image: "/images/projects/RedPortfolio/5.png",
  },
  {
    image: "/images/projects/RedPortfolio/6.png",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mb-48 mt-10 md:mt-0">
        ...
        <div className="flex flex-col gap-4 px-10 md:pl-10 md:pr-0 lg:px-0">
          ...
          <p className="md:w-[90%] lg:w-[80%] text-violet text-base font-poppins mb-5">
            This is a simple and modern protfolio that you can use to showcase your skills,
            projects, experiences, contact info, and other personal information.
            I call it, "the Red Portfolio"! <br />
            This is responsive and has a nice-looking design. This portfolio was
            developed by React.js, JavaScript, SASS, and other useful
            technologies. <br />
            Please feel free to check out my Red portfolio.
          </p>

          <span className="flex flex-col md:flex-row gap-4 z-10">
            <CustomButton
              text="View the Project"
              href="https://meraj-portfolio.pages.dev/"
              target="_blank"
            />
            <CustomButton
              text="View On GitHub"
              href="https://github.com/Meraj-Mazidi/react-red-portfolio-scss"
              target="_blank"
            />
          </span>
        </div>
        ...
        <div className="flex flex-col justify-center items-center z-10 px-6 lg:px-0 mt-20 md:mt-0">
          <a href="https://meraj-portfolio.pages.dev/" target="_blank">
            <Tilt
              scale="1.1"
            ...
            >
              <img
                src={"/images/projects/red-portfolio.png"}
                alt="projectDemo"
