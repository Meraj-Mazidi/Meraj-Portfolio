...
const BlogImages = [
  {
    image: "/images/projects/next Blog/1.png",
  },
  {
    image: "/images/projects/next Blog/2.png",
  },
  {
    image: "/images/projects/next Blog/3.png",
  },
  {
    image: "/images/projects/next Blog/4.png",
  },
  {
    image: "/images/projects/next Blog/5.png",
  },
  {
    image: "/images/projects/next Blog/6.png",
  },
  {
    image: "/images/projects/next Blog/7.png",
  },
  {
    image: "/images/projects/next Blog/8.png",
  },
];
    ...
    <section className="w-full font-poppins">
      <div className="grid grid-cols-1 md:grid-cols-2 mb-48 mt-10 md:mt-0">
        ...
        <div className="flex flex-col gap-4 px-10 md:pl-10 md:pr-0 lg:px-0">
          ...
          <p className="md:w-[90%] lg:w-[80%] text-violet text-base font-poppins mb-5">
            This is a dynamic blog project, in which you can upload new posts
            from the server and it will be dynamically shown on this blog.
            Actual comments section and also a list of categories that you can
            choose from to check out related posts. <br />
            This project was developed by Next.js, Tailwind CSS, Graph QL, and
          ...
          <span className="flex flex-col md:flex-row gap-4 z-10">
            <CustomButton
              ...
              href="https://meraj-next-js-blog.vercel.app/"
              target="_blank"
            />
            <CustomButton
              text="View On GitHub"
              href="https://github.com/Meraj-Mazidi/Next.js-Creative-Landing-Page"
              target="_blank"
            />
          </span>
        </div>
        ...
        <div className="flex flex-col justify-center items-center z-10 px-6 lg:px-0 mt-20 md:mt-0">
          <a href="https://meraj-next-js-blog.vercel.app/" target="_blank">
            ...
            >
              <img
                src={"/images/projects/Next-JS-Blog.png"}
                alt="projectDemo"
      ...
      <div className="mt-[100px]">
        <div className="flex flex-col items-center text-center px-4">
          ...
          <p className="md:w-[650px] text-center text-violet text-base">
            Let's take a little sneak peek of some screenshots and pages of this project, you can also check out the project yourself. It's live and rocking!
          </p>
        </div>
