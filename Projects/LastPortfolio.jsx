...
const BlogImages = [
  {
    image: "/images/projects/LastPortfolio/1.png",
  },
  {
    image: "/images/projects/LastPortfolio/2.png",
  },
  {
    image: "/images/projects/LastPortfolio/3.png",
  },
  {
    image: "/images/projects/LastPortfolio/4.png",
  },
  {
    image: "/images/projects/LastPortfolio/5.png",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mb-48 mt-10 md:mt-0">
        ...
        <div className="flex flex-col gap-4 px-10 md:pl-10 md:pr-0 lg:px-0">
          ...
          <p className="md:w-[90%] lg:w-[80%] text-violet text-base font-poppins mb-5">
            This beautiful peace of work was my last portfolio, with a fully
            responsive design, and nice-looking smooth animations that makes a
            great impression on it's viewers. <br />
            This portfolio was developed by React,js, JavaScript, React
            Bootstrap, and other useful technologies. <br />
            Please feel free to check out this beautiful portfolio.
          </p>
          ...
          <span className="flex flex-col md:flex-row gap-4 z-10">
            ...
            <CustomButton
              text="View On GitHub"
              href="https://github.com/Meraj-Mazidi/meraj-main-portfolio"
              target="_blank"
            />
          </span>
        </div>
        ...
        <div className="flex flex-col justify-center items-center z-10 px-6 lg:px-0 mt-20 md:mt-0">
          <a href="https://meraj-last-portfolio.pages.dev/" target="_blank">
            <Tilt
              scale="1.1"
            ...
            >
              <img
                src={"/images/projects/last-Portfolio.png"}
                alt="projectDemo"
