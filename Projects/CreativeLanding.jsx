...
const BlogImages = [
  {
    image: "/images/projects/landing/1.png",
  },
  {
    image: "/images/projects/landing/2.png",
  },
  {
    image: "/images/projects/landing/3.png",
  },
  {
    image: "/images/projects/landing/4.png",
  },
  {
    image: "/images/projects/landing/5.png",
  },
  {
    image: "/images/projects/landing/6.png",
  },
  {
    image: "/images/projects/landing/7.png",
  },
  {
    image: "/images/projects/landing/8.png",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mb-48 mt-10 md:mt-0">
        ...
        <div className="flex flex-col gap-4 px-10 md:pl-10 md:pr-0 lg:px-0">
          ...
          <p className="md:w-[90%] lg:w-[80%] text-violet text-base font-poppins mb-5">
            This is a Landing page for a creative business agency, that offeres
            it's great products throught their landing. <br />
            This is a single page project, fully responsive, cool-looking,
            modern and creative in design. <br />
            This project was developed by React.js, Tailwind CSS. <br />
            Please feel free to check out this beautiful landing page.
          </p>

          <span className="flex flex-col md:flex-row gap-4 z-10">
            <CustomButton
              text="View the Project"
              href="https://next-js-creative-landing-page.vercel.app/"
              target="_blank"
            />
            <CustomButton
              text="View On GitHub"
        ...
        <div className="flex flex-col justify-center items-center z-10 px-6 lg:px-0 mt-20 md:mt-0">
          ...
          >
            ...
            >
              <img
                src={"/images/projects/Next-Creative-Agency.png"}
                alt="projectDemo"
