...
const BlogImages = [
  {
    image: "/images/projects/Bank/1.png",
  },
  {
    image: "/images/projects/Bank/2.png",
  },
  {
    image: "/images/projects/Bank/3.png",
  },
  {
    image: "/images/projects/Bank/4.png",
  },
  {
    image: "/images/projects/Bank/5.png",
  },
  {
    image: "/images/projects/Bank/6.png",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mb-48 mt-10 md:mt-0">
        ...
        <div className="flex flex-col gap-4 px-10 md:pl-10 md:pr-0 lg:px-0">
          ...
          <p className="md:w-[90%] lg:w-[80%] text-violet text-base font-poppins mb-5">
            This is a beautiful and delicate landing page for a bank, that is
            fully responsive and also incredibly modern, with eye-catching
            colors and smooth animations that makes a real good impression on
            it's users. <br />
            This project was developed by React.js, Vite JS, Tailwind CSS, and
          ...
          <span className="flex flex-col md:flex-row gap-4 z-10">
            <CustomButton
              ...
              href="https://meraj-modern-bank-website.pages.dev/"
              target="_blank"
            />
            <CustomButton
              text="View On GitHub"
              href="https://github.com/Meraj-Mazidi/Modern-Bank-Design-React"
              target="_blank"
            />
          </span>
        </div>
        ...
        <div className="flex flex-col justify-center items-center z-10 px-6 lg:px-0 mt-20 md:mt-0">
          ...
          >
            ...
            >
              <img
                src={"/images/projects/Modern-Bank.png"}
                alt="projectDemo"
