...
const BlogImages = [
  {
    image: "/images/projects/CryptoWorld/1.png",
  },
  {
    image: "/images/projects/CryptoWorld/2.png",
  },
  {
    image: "/images/projects/CryptoWorld/3.png",
  },
  {
    image: "/images/projects/CryptoWorld/4.png",
  },
  {
    image: "/images/projects/CryptoWorld/5.png",
  },
  {
    image: "/images/projects/CryptoWorld/6.png",
  },
  {
    image: "/images/projects/CryptoWorld/7.png",
  },
  {
    image: "/images/projects/CryptoWorld/8.png",
  },
  {
    image: "/images/projects/CryptoWorld/9.png",
  },
  {
    image: "/images/projects/CryptoWorld/10.png",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mb-48 mt-10 md:mt-0">
        ...
        <div className="flex flex-col gap-4 px-10 md:pl-10 md:pr-0 lg:px-0">
          ...
          <p className="md:w-[90%] lg:w-[80%] text-violet text-base font-poppins mb-5">
            This a website for Crypto Currency lovers, in which you can find the
            latest prices and other vital information regarding some major
            crypto currencies in the world. <br />
            You can also see the latest news related to each currency and find
            them by searching their name. Access LIVE data on market and
            exchange information here. <br />
            This project was developed by React.js and Tailwind CSS. It receives
            live data from a server and dynamically displays it.
          </p>

          <span className="flex flex-col md:flex-row gap-4 z-10">
            <CustomButton
              text="View the Project"
              href="https://meraj-crypto-world.pages.dev/"
              target="_blank"
            />
            <CustomButton
              text="View On GitHub"
              href="https://github.com/Meraj-Mazidi/cryptoWorld"
              target="_blank"
            />
          </span>
        </div>
        ...
        <div className="flex flex-col justify-center items-center z-10 px-6 lg:px-0 mt-20 md:mt-0">
          <a href="https://meraj-crypto-world.pages.dev/" target="_blank">
            <Tilt
              scale="1.1"
