...
const Work = () => {
  ...
  return (
    <section className="w-screen pl-10 lg:pl-32 xl:container xl:mx-auto mt-[100px]" id="work" ref={ref}>
      <div className="w-full grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 relative">
        ...
        {/* Left Side */}
        <div
          className="md:col-span-2 lg:col-span-1 h-full flex flex-col gap-5 py-5 font-poppins relative pl-10 lg:pl-0"
          style={{
        ...
        >
          ...
          <p className="text-white font-base text-3xl w-[80%] leading-9">
            Currently working on a traveling and sports company called{" "}
            <span className="text-pink font-bold">Moverii</span>, as a
          </p>

          <span className="flex flex-col">
            <p className="text-white font-extrabold text-5xl md:text-7xl w-[80%] font-poppins mb-8">
              Front-end Developer
            </p>

            <Link href="/projects/moverii">
              <div
                className={`px-6 sm:px-4 xl:px-6 py-4 w-fit text-base h-25 transition-all rounded overflow-hidden border-2 hover:shadow-light-xl hover:outline-none hover:border-pink focus:outline-none font-poppins font-bold z-10 bg-pink text-blue hover:text-pink hover:bg-transparent border-transparent cursor-pointer`}
              >
